...
The main pipeline is in `code.ipynb`, which benchmarks RealNVP, MDN, TabSyn, and TabPFN against a Quantile Random Forest baseline for imputing net worth from the Survey of Consumer Finances onto the Current Population Survey.
